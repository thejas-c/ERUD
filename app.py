...
def fetch_video_links(sheet_id):
    ...
    if response.status_code != 200:
        print("API Error:", response.text)  # ✅ Debug API response
    ...
    print("Fetched Video Links:", links)  # ✅ Debug video URLs
...
def get_videos():
    class_language = request.args.get("class_language")  # Get selection from frontend
...
def home():
    ...
    return send_file("static/ed.html")
